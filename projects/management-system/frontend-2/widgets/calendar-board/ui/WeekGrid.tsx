...
export function WeekGrid({
  ...
  return (
    <div
      className={cn(
        "border-border-subtle bg-bg-app mx-4 flex flex-col overflow-hidden rounded-xl border shadow-sm sm:mx-6 md:mb-4 md:min-h-0 md:flex-1",
        className
      )}
    >
      <div
      ...
      >
        {cells.map((cell, index) => (
          <GridDayCell
            ...
            isLastRow
            date={cell.date}
            isLastInRow={index === GRID_COLUMNS - 1}
