...
function ExcavationJobNameCell({ job }: { job: Job }) {
...
function ExcavationJobActionsCell({
  job,
  onShowMore,
  onTrash,
  onUnarchive,
...
export const getExcavationJobColumns = (
  onShowMore: (id: number, isArchived: boolean) => void,
  onTrash: (id: number) => void,
  onUnarchive: (id: number) => void,
  onArchive: (id: number) => void,
  ...
  builder.addColumn({
    ...
    header: "Job Name",
    cell: ({ row }) => <ExcavationJobNameCell job={row.original} />,
  });
